    ...
    <section class="content-section bg-light" id="about">
        <div class="container px-4 px-lg-5 text-center">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-10">
                    <h2 data-aos="flip-up" data-aos-offset="480" data-aos-duration="500">Ayoo! Flo!</h2>
                    <p class="lead mb-5" data-aos="flip-down" data-aos-offset="400" data-aos-duration="700">
                        🌱 Tertarik dengan tumbuhan 🌱
                    </p>
                    <a class="btn btn-dark btn-xl" href="#tentang" data-aos="flip-down" data-aos-offset="400"
    ...
    <section class="content-section bg-primary text-white text-center" id="tentang">
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5">
                <div class="col-lg-3 col-md-6 mb-5 mb-lg-0" data-aos="flip-up" data-aos-offset="300"
                ...
                <div class="col-lg-3 col-md-6 mb-5 mb-lg-0" data-aos="flip-down" data-aos-offset="340"
                    data-aos-duration="600">
                ...
                <div class="col-lg-3 col-md-6 mb-5 mb-md-0"data-aos="flip-up" data-aos-offset="370" data-aos-duration="600">
                ...
                <div class="col-lg-3 col-md-6" data-aos="flip-down" data-aos-offset="410" data-aos-duration="600">
