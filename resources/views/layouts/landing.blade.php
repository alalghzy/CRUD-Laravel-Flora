...
<body id="page-top">
    ...
    @auth
        @if (auth()->user()->role == 'admin')
            <a href="{{ route('home') }}" class="btn rounded menu-admin"><i class="fa-solid fa-house"></i></a>
        @endif
    @endauth
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            @auth
                @if (auth()->user()->role == 'admin')
                    <li class="sidebar-nav-item"><a href="{{ route('home') }}" class="btn btn-info m-3" style="color: #ffffff"><i
